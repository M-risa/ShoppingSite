...
public class UserDAO extends DAO {
	...
	// 新規登録用のメールアドレス重複チェック
	public boolean existsMailAddress(String mailAddress) throws Exception {
		boolean result = false;
		Connection con = getConnection();

		String sql = "SELECT COUNT(*) FROM users WHERE MAIL_ADDRESS = ?";
	...
	// 会員編集用のメールアドレス重複チェック
	public boolean existsMailAddressForEdit(String mailAddress, String MemberId) throws Exception {
		boolean result = false;
		Connection con = getConnection();
