...
<body id="admin-body">
	...
	<div class="adminMainContainer">
		...
		<form
			...
			<div class="confirm-group">
				<span class="confirm-label">カテゴリー：</span> <span
					class="confirm-value"> 
			...
			<div class="confirm-group">
				<span class="confirm-label">初期在庫数：</span> <span
					class="confirm-value">${param.stock} 個</span> <input type="hidden"
			...
			<input type="submit" value="登録" class="btn-edit"> <input
				type="button" value="戻る" class="btn-back" onclick="history.back()">
		</form>
	</div>
